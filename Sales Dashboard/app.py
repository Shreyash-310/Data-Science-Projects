...
st.sidebar.header('Pleae Filter Here:')
...
st.title(":bar_chart: Sales Dashbaord")
st.markdown("##")
...
sales_by_product_line = df_selection.groupby(by = df['Product line']).sum()[['Total']].sort_values(by='Total')
